...
- `docker-compose.backup.yml` + `tests/dr/` — WAL archiving overlay and a one-command PITR restore drill (marker before/after T, CRDT rebuild hash comparison); see `docs/runbooks/disaster-recovery.md`. Not run in CI.
